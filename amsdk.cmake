...
elseif(${CMAKE_CXX_COMPILER_ID} MATCHES "GNU")
    add_compile_options(-Wno-volatile -fno-exceptions -fno-threadsafe-statics -Wno-unused-result -Wno-non-virtual-dtor
                        ...
                        -Wno-switch -Wno-array-bounds -msse -fvisibility=hidden -mfpmath=sse -Wsign-compare -Wclass-memaccess
    )
    if (NOT HL2SDK_64BIT)
...
if (HL2SDK_ENGINE_VERSION EQUAL 12)
    ...
    target_link_libraries(tier0 INTERFACE tier0${HL2SDK_LIB_STATIC_SUFFIX}${HL2SDK_LIB_STATIC_EXT})
        ...
        if (HL2SDK_64BIT)
            target_link_libraries(tier0 INTERFACE ${HL2SDK_LIB_DIR}/${HL2SDK_LIB_PREFIX}tier0_client${HL2SDK_LIB_SHARED_EXT})
        else()
            target_link_libraries(tier0 INTERFACE ${HL2SDK_LIB_DIR}/${HL2SDK_LIB_PREFIX}tier0${HL2SDK_LIB_SHARED_EXT})
        endif()
    endif()
else()
    message(FATAL_ERROR "Unknown engine version found: \"${HL2SDK_ENGINE_BRANCH}\"")
...
if (HL2SDK_ENGINE_VERSION EQUAL 12)
    ...
    if (WIN32)
        ...
        if (HL2SDK_64BIT)
            target_link_libraries(vstdlib INTERFACE ${HL2SDK_LIB_DIR}/${HL2SDK_LIB_PREFIX}vstdlib_client${HL2SDK_LIB_SHARED_EXT})
        else()
            target_link_libraries(vstdlib INTERFACE ${HL2SDK_LIB_DIR}/${HL2SDK_LIB_PREFIX}vstdlib${HL2SDK_LIB_SHARED_EXT})
        endif()
    endif()
else()
    message(FATAL_ERROR "Unknown engine version found: \"${HL2SDK_ENGINE_BRANCH}\"")
